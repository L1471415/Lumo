...
def get_time_at(location):
    try:
        ...
        playsound('./files/error_audio/ElevenLabs_getTime.mp3')
...
def send_text(twilio_client, contact_name, message):
    try:
        ...
        playsound('./files/error_audio/ElevenLabs_sendText.mp3')
...
def get_weather(request):
    try:
        ...
        playsound('./files/error_audio/ElevenLabs_getWeather.mp3')
...
def get_weather_at(location, request):
    try:
        ...
        playsound('./files/error_audio/ElevenLabs_getWeatherLocation.mp3')
...
def generate_image(prompt):
    try:
        ...
        playsound('./files/error_audio/ElevenLabs_generateImage.mp3')
...
def search_web(query):
    try:
        ...
        playsound('./files/error_audio/ElevenLabs_searchWeb.mp3')
...
def find_nearby_locations(location_type, location=None):
    try:
        ...
        playsound('./files/error_audio/ElevenLabs_findNearbyLocation.mp3')
...
def set_alarm_static(time):
    try:
        ...
        playsound('./files/error_audio/ElevenLabs_setAlarm.mp3')
...
def set_alarm_static_at(time, repeat_days):
    try:
        ...
        playsound('./files/error_audio/ElevenLabs_AlarmAt.mp3')
...
def remove_alarm_static(time):
    try:
        ...
        playsound('./files/error_audio/ElevenLabs_removeAlarm.mp3')
        return f"Error, invalid time {time}. "
